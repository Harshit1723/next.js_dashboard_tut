...
import Link from 'next/link'; {lusitana}
  ...
  return (
    <main className="flex min-h-screen flex-col p-6 bg-black text-white ">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-black text-white px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${lusitana.className} text-xl text-gray-500`}>
